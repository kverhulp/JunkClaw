...
| Token | Hex | Use |
|---|---|---|
| `--accent` | `#0284C7` | Primary actions, active tab, focus ring |
| `--accent-hover` | `#0369A1` | Pressed and hover |
| `--accent-quiet` | `#0C4A6E` | Accent fills behind text |
| `--positive` | `#059669` | Below-market price, savings |
| `--warning` | `#D97706` | Risk flags, thin comp sets |
| `--critical` | `#DC2626` | Salvage titles, hard failures |

Semantic colour is separate from the accent and never doubles as decoration. A
green figure means *below comparable asking prices* — nothing else.
